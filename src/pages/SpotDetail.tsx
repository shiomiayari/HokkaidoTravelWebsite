      ...
      >
        ...
        <div
          style={{
            ...
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.3) 0%, transparent 40%, transparent 60%, rgba(0,0,0,0.6) 100%)",
          }}
        />
      ...
      <div className="px-6 pt-8">
        ...
        <div className="flex flex-col gap-3 pb-12">
          ...
          <motion.button
            ...
            style={{
              border: `1px solid ${
                saved ? "var(--color-wine)" : "rgba(28,26,23,0.2)"
              }`,
          ...
          >
            <span
              ...
              style={{
                fontSize: 15,
                fontWeight: 500,
                color: saved ? "var(--color-wine)" : "var(--color-charcoal)",
              }}
            >
              {saved ? "保存済み" : "行きたい"}
            </span>
          ...
          >
            ...
            <AnimatePresence mode="wait">
              {goConfirm ? (
                ...
                <motion.span key="arrow" style={{ fontSize: 18 }}>
                  →
                </motion.span>
              )}
            </AnimatePresence>
