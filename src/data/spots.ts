...
export const spots: Spot[] = [
  {
    ...
    nameEn: 'OTARU BINE',
    category: 'WINE / LUNCH',
    description: '歴史ある石造りの倉庫を改装したワインレストラン。小樽ワインを樽から直接グラスに注いでくれる。ゆっくりとしたランチにちょうどいい。',
    area: '小樽中心部 / 色内',
    duration: '60〜90分',
    vibe: ['ワイン', 'ゆっくり', 'ランチ'],
  ...
  },
  {
    ...
    description: '明治時代の倉庫を改築したガラス工芸品店。167個の石油ランプが灯す幻想的な空間が有名。ガラス細工の器やアクセサリーが揃う。',
    area: '堺町通り',
    duration: '30〜45分',
    vibe: ['レトロ', 'アート', 'お土産'],
  ...
  },
  {
    ...
    description: '明治45年建造の旧共成株式会社倉庫を利用したオルゴール専門店。3,000種類以上が並ぶ。蒸気時計が目印。',
    area: '堺町通り',
    duration: '30〜45分',
    vibe: ['レトロ', 'お土産', 'フォト'],
  ...
  },
  {
    ...
    category: 'DRIVE / VIEW',
    description: '小樽市街と石狩湾を一望できる標高532mの展望台。ロープウェイで登れる。晴れた日は積丹半島まで見える。夕暮れが格別。',
    area: '小樽郊外 / 要ドライブ',
    duration: '60〜90分',
    vibe: ['ドライブ', '絶景', '夕暮れ'],
  ...
  },
  {
    ...
    description: '大正12年に完成した全長1,140mの運河。石造りの倉庫群が立ち並ぶ景観は、かつて「北のウォール街」と呼ばれた小樽の面影を今に伝える。',
    area: '小樽中心部',
    duration: '30〜60分',
    vibe: ['散歩', 'フォト', '夕暮れ'],
  ...
  },
  {
    ...
    description: '運河沿いの石造り倉庫を改装したブリュワリーレストラン。醸造タンクを眺めながら出来立ての小樽ビールが飲める。',
    area: '運河沿い',
    duration: '90〜120分',
    vibe: ['ビール', 'ディナー', '雰囲気'],
  ...
  },
  {
    ...
    nameEn: 'TANAKA SAKE',
    category: 'SAKE / SHOP',
    description: '明治35年創業の老舗酒蔵。北海道の厳選された米と伏流水で仕込んだ純米酒が揃う。試飲もできる。空港前の最後のお買い物に最適。',
    area: '小樽 / 祝津',
    duration: '30〜45分',
    vibe: ['日本酒', 'お土産', 'ローカル'],
